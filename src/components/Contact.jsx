...
const socialLinks = [
  {
    href: 'https://www.linkedin.com/in/dhiwaaqsha',
  ...
  {
    href: 'https://www.instagram.com/dhiwaqpr',
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              name="message"
              id="message"
              placeholder="Hi, I'm interested in collaborating with you on a project. I'd be happy to discuss how we can work together."
              required
